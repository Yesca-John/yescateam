  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "bg-gray-300 dark:bg-gray-600 relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-2 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-2"
        )}
      >
